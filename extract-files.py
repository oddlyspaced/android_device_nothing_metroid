...
AIDL_VERSION_REMAP = {
    'android.automotive.watchdog-V2-ndk': 'android.automotive.watchdog-V3-ndk',
    'android.frameworks.cameraservice.device-V2-ndk': 'android.frameworks.cameraservice.device-V3-ndk',
    'android.frameworks.cameraservice.service-V2-ndk': 'android.frameworks.cameraservice.service-V3-ndk',
    'android.hardware.audio.common-V3-ndk': 'android.hardware.audio.common-V4-ndk',
    'android.hardware.audio.core-V2-ndk': 'android.hardware.audio.core-V4-ndk',
    'android.hardware.audio.core-V3-ndk': 'android.hardware.audio.core-V4-ndk',
    'android.hardware.audio.core.sounddose-V1-ndk': 'android.hardware.audio.core.sounddose-V3-ndk',
    'android.hardware.audio.core.sounddose-V2-ndk': 'android.hardware.audio.core.sounddose-V3-ndk',
    'android.hardware.audio.effect-V2-ndk': 'android.hardware.audio.effect-V3-ndk',
    ...
    'android.hardware.bluetooth.audio-V3-ndk': 'android.hardware.bluetooth.audio-V5-ndk',
    'android.hardware.bluetooth.audio-V4-ndk': 'android.hardware.bluetooth.audio-V5-ndk',
    'android.hardware.gnss-V4-ndk': 'android.hardware.gnss-V6-ndk',
    'android.hardware.graphics.allocator-V1-ndk': 'android.hardware.graphics.allocator-V2-ndk',
    'android.hardware.graphics.common-V5-ndk': 'android.hardware.graphics.common-V7-ndk',
    'android.hardware.graphics.common-V6-ndk': 'android.hardware.graphics.common-V7-ndk',
    'android.hardware.health-V1-ndk': 'android.hardware.health-V4-ndk',
    'android.hardware.health-V2-ndk': 'android.hardware.health-V4-ndk',
    'android.hardware.nfc-V1-ndk': 'android.hardware.nfc-V2-ndk',
    'android.hardware.power-V5-ndk': 'android.hardware.power-V6-ndk',
    'android.hardware.radio-V2-ndk': 'android.hardware.radio-V4-ndk',
    'android.hardware.radio-V3-ndk': 'android.hardware.radio-V4-ndk',
    'android.hardware.radio.config-V3-ndk': 'android.hardware.radio.config-V4-ndk',
    'android.hardware.radio.data-V2-ndk': 'android.hardware.radio.data-V4-ndk',
    'android.hardware.radio.data-V3-ndk': 'android.hardware.radio.data-V4-ndk',
    'android.hardware.radio.messaging-V3-ndk': 'android.hardware.radio.messaging-V4-ndk',
    'android.hardware.radio.modem-V3-ndk': 'android.hardware.radio.modem-V4-ndk',
    'android.hardware.radio.network-V2-ndk': 'android.hardware.radio.network-V4-ndk',
    'android.hardware.radio.network-V3-ndk': 'android.hardware.radio.network-V4-ndk',
    'android.hardware.radio.sim-V3-ndk': 'android.hardware.radio.sim-V4-ndk',
    'android.hardware.radio.voice-V3-ndk': 'android.hardware.radio.voice-V4-ndk',
    'android.hardware.security.keymint-V2-ndk': 'android.hardware.security.keymint-V4-ndk',
    ...
    'android.hardware.sensors-V2-ndk': 'android.hardware.sensors-V3-ndk',
    'android.hardware.soundtrigger3-V1-ndk': 'android.hardware.soundtrigger3-V3-ndk',
    'android.hardware.thermal-V1-ndk': 'android.hardware.thermal-V3-ndk',
    'android.hardware.thermal-V2-ndk': 'android.hardware.thermal-V3-ndk',
    'android.hardware.vibrator-V2-ndk': 'android.hardware.vibrator-V3-ndk',
    'android.hardware.wifi-V2-ndk': 'android.hardware.wifi-V3-ndk',
    'android.hardware.wifi.common-V1-ndk': 'android.hardware.wifi.common-V2-ndk',
    'android.hardware.wifi.hostapd-V2-ndk': 'android.hardware.wifi.hostapd-V3-ndk',
    'android.hardware.wifi.supplicant-V3-ndk': 'android.hardware.wifi.supplicant-V4-ndk',
    'android.media.audio.common.types-V2-cpp': 'android.media.audio.common.types-V4-cpp',
    'android.media.audio.common.types-V2-ndk': 'android.media.audio.common.types-V4-ndk',
    'android.media.audio.common.types-V3-ndk': 'android.media.audio.common.types-V4-ndk',
    'android.system.keystore2-V1-ndk': 'android.system.keystore2-V5-ndk',
    'vendor.qti.hardware.camera.aon-V2-ndk': 'vendor.qti.hardware.camera.aon-V3-ndk',
    'vendor.qti.hardware.display.color-V1-ndk': 'vendor.qti.hardware.display.color-V2-ndk',
    'vendor.qti.hardware.display.config-V12-ndk': 'vendor.qti.hardware.display.config-V15-ndk',
    'vendor.qti.hardware.display.config-V2-ndk': 'vendor.qti.hardware.display.config-V15-ndk',
    'vendor.qti.hardware.display.config-V5-ndk': 'vendor.qti.hardware.display.config-V15-ndk',
    'vendor.qti.hardware.display.config-V7-ndk': 'vendor.qti.hardware.display.config-V15-ndk',
    'vendor.qti.hardware.paleventnotifier-V2-ndk': 'vendor.qti.hardware.paleventnotifier-V3-ndk',
}
